export const RETIREMENT_KNOWLEDGE_BASE = `
...
Available intents:
1. cpf_inquiry — CPF accounts, interest rates, contribution rates, CPF Life, CPF withdrawal
2. retirement_planning — Retirement age, income needs, goals, when to retire, how much to save
3. retirement_gap — Shortfall calculation, am I on track, how much more to save, closing the gap
4. investment_options — SRS, unit trusts, endowment, annuity, OCBC RoboInvest, investing for retirement
5. life_events — Marriage, children's education, property purchase, micro-retirement, career breaks

Respond with ONLY valid JSON, no other text:
{"intent": "<intent_id>", "confidence": <0.0-1.0>, "inScope": <true|false>}

If the message is about anything other than retirement planning (e.g. savings rates, credit cards, loans, stock tips, general insurance): {"intent": null, "confidence": 0.0, "inScope": false}`;
